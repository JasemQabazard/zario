...
/* ==========================================================================
  ...
  zarioRouter.post('/mailer', function (req, res, next) {
   ...
   var mailOptions = {
       ...
       html: '<p>Dear Valued Member: Your transaction at our Merchant: </p><strong>' + req.body.merchant + '</strong><p> for purchase of: </p><strong>' + req.body.description + '</strong><p> for the amount of: </p><strong>' + req.body.amount + '</strong><p> and at an awarded discount of: </p><strong>' + req.body.discount + '</strong><p> has been fully registered to your account adding: </p><strong>' + req.body.merits + '</strong><p> merit points to your loyalty bands; as well as adding: </p><strong>' + req.body.zarios + '</strong><p> zario coins to your ownership. We thank you for your contribution. </p></p>Please access your dashboard data to see your latest activity. </p><p>Best Regards.</p><p>Zario and The Black Diamond loyalty Program.</p><p><strong>note: </strong> for any further enquiries please contact our Help Desk Suppprt.</p>'
   };
